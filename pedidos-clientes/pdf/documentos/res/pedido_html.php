...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		...
		<tr>
			<td style="width:45%; ">
				<?php echo $rw_proveedor['nombre_cliente']?><br>
...
$insert=mysqli_query($con,"INSERT INTO pedidos VALUES ('','$numero_pedido','$date','$cliente','$transporte','$condiciones','$comentarios')");
